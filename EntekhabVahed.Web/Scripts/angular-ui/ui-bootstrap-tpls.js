           ...
           return {
               ...
               link: function (originalScope, element, attrs, modelCtrl) {
                   ...
                   function recalculatePosition() {
                       ...
                       scope.position.right = $(window).width() - (element.offset().left + element.outerWidth());
                   }
...
angular.module("template/typeahead/typeahead-popup.html", []).run(["$templateCache", function ($templateCache) {
    $templateCache.put("template/typeahead/typeahead-popup.html",
      "<ul class=\"dropdown-menu\" ng-show=\"isOpen() && !moveInProgress\" ng-style=\"{top: position().top+'px', right: position().right+'px'}\" style=\"display: block;\" role=\"listbox\" aria-hidden=\"{{!isOpen()}}\">\n" +
